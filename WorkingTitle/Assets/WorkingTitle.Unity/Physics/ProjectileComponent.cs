...
namespace WorkingTitle.Unity.Physics
{
    public class ProjectileComponent : SerializedMonoBehaviour
    {
        ...
        void HandleRicochet(Vector2 contactPosition, Vector2 contactNormal)
        {
            ...
            //if (correctNormalSign < 0) Debug.Log("normal sign corrected!");
            ...
            Rigidbody.rotation = Vector2.SignedAngle(Vector2.up, reflectionDirection);
            Rigidbody.velocity = reflectionDirection;
